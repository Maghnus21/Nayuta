...
func _ready():
	dialogue_array = [
		"good, you’ve landed at the target area. preliminary scans of the nearby building shows there’s [ENEMY COUNT] Craimh. the head honchos requested for an extermination order, in collaberation with MHI.",
		...
		"scans have shown the craimh are low level, stage 1s, so you shouldn’t have too much trouble, but they can still do damage so stay alert.",
